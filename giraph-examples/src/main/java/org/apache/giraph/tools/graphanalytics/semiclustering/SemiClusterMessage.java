...
public class SemiClusterMessage implements
  ...
  public void addVertexList(
      List<Vertex<IntWritable, SemiClusterMessage, DoubleWritable, SemiClusterMessage>> list) {
    for (Vertex<IntWritable, SemiClusterMessage, DoubleWritable, SemiClusterMessage> v : list) {
      addVertex(v);
    }
  }
  ...
  public boolean contains(IntWritable vertexID) {
    for (Vertex<IntWritable, SemiClusterMessage, DoubleWritable, SemiClusterMessage> v : this.semiClusterVertexList) {
  ...
  public void write(DataOutput out) throws IOException {
    ...
    if (this.semiClusterVertexList == null) {
      ...
      for (Vertex<IntWritable, SemiClusterMessage, DoubleWritable, SemiClusterMessage> v : semiClusterVertexList) {
       ((SemiClusteringVertex)v).write(out);
      }
    }
